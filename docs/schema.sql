...
CREATE TABLE `rbac_role` (
  ...
  `title` varchar(255) COLLATE utf8_general_ci NOT NULL DEFAULT 'newbie',
  `image` varchar(32) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `display_name` varchar(64) COLLATE utf8_general_ci NOT NULL,
  `real_name` varchar(64) COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `template` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'default',
  `language` varchar(32) COLLATE utf8_general_ci NOT NULL DEFAULT 'en-GB',
  `tumblr` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `last_fm` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `homepage` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `icq` varchar(16) COLLATE utf8_general_ci DEFAULT NULL,
  `msn` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `yim` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `aim` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `gtalk` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `skype` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `twitter` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `flickr` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `deviantart` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `vimeo` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `youtube` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `facebook` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `myspace` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `bebo` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `avatar` varchar(32) COLLATE utf8_general_ci DEFAULT 'default_avatar.png',
  `usertext` varchar(255) COLLATE utf8_general_ci DEFAULT 'Viva La Revolution!',
  `signature` text COLLATE utf8_general_ci,
